...
static const QList<Example> g_examples = {
    { "──── 2D Explicit ────", -1, {},{},{},{},{},{}, -10, 10, 500, Qt::blue },
    { "Sine wave  y=sin(x)",       MODE_2D_EXPLICIT, "sin(x)", {},{},{},{},{}, -6.28, 6.28, 400, QColor(0,120,200) },
    { "Parabola  y=x^2",           MODE_2D_EXPLICIT, "x^2",    {},{},{},{},{}, -5,    5,    300, QColor(200,80,0) },
    { "Cubic  y=x^3-3*x",          MODE_2D_EXPLICIT, "x^3-3*x",{},{},{},{},{}, -3,    3,    300, QColor(160,0,200) },
    { "Gaussian  y=exp(-x^2)",     MODE_2D_EXPLICIT, "exp(-x^2)",{},{},{},{},{}, -4,   4,    400, QColor(0,180,100) },
    { "Damped sine  y=sin(x)/x",   MODE_2D_EXPLICIT, "sin(x)/x", {},{},{},{},{}, -20,  20,   600, QColor(200,0,100) },
    { "Abs cosine  y=abs(cos(x))",  MODE_2D_EXPLICIT, "abs(cos(x))",{},{},{},{},{}, -6.28, 6.28, 400, QColor(0,160,180) },
    { "──── 2D Parametric ────", -1, {},{},{},{},{},{}, 0, 6.28, 500, Qt::blue },
    { "Circle  x=cos(t), y=sin(t)",          MODE_2D_PARAMETRIC, {}, "cos(t)", "sin(t)", {},{}, 0, 6.28, 360, QColor(0,100,220) },
    { "Ellipse  x=2cos(t), y=sin(t)",        MODE_2D_PARAMETRIC, {}, "2*cos(t)", "sin(t)", {},{}, 0, 6.28, 360, QColor(200,60,0) },
    { "Lissajous  x=sin(3t), y=sin(2t)",     MODE_2D_PARAMETRIC, {}, "sin(3*t)", "sin(2*t)", {},{}, 0, 6.28, 600, QColor(160,0,200) },
    { "Archimedean spiral  x=t*cos(t),y=t*sin(t)", MODE_2D_PARAMETRIC, {}, "t*cos(t)", "t*sin(t)", {},{}, 0, 25.13, 800, QColor(0,160,80) },
    { "Rose  x=cos(4t)cos(t), y=cos(4t)sin(t)",    MODE_2D_PARAMETRIC, {}, "cos(4*t)*cos(t)", "cos(4*t)*sin(t)", {},{}, 0, 6.28, 800, QColor(220,30,80) },
    { "──── 3D Parametric ────", -1, {},{},{},{},{},{}, 0, 30, 600, Qt::blue },
    { "Helix  x=cos(t), y=sin(t), z=t/5",           MODE_3D_PARAMETRIC, {},{},{}, "cos(t)", "sin(t)", "t/5",    0, 30, 600, QColor(0,120,220) },
    { "Conical helix  x=t*cos(t),y=t*sin(t),z=t",   MODE_3D_PARAMETRIC, {},{},{}, "t*cos(t)", "t*sin(t)", "t",  0, 12.56, 600, QColor(200,80,0) },
    { "Trefoil knot",                                MODE_3D_PARAMETRIC, {},{},{},
      "sin(t)+2*sin(2*t)", "cos(t)-2*cos(2*t)", "-sin(3*t)", 0, 6.28, 600, QColor(160,0,200) },
    { "Viviani curve",                               MODE_3D_PARAMETRIC, {},{},{},
